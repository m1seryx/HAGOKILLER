...
const styles = StyleSheet.create({
  ...
  topTitle: { color: '#000000', fontSize: 17, fontWeight: '700' },
  editButton: {
    minWidth: 40,
    height: 40,
    borderRadius: 12,
  ...
  editButtonText: { color: '#0284c7', fontWeight: '800', fontSize: 13 },
  ...
  name: { color: '#000000', fontSize: 26, fontWeight: '800', marginBottom: 4 },
  brand: { color: '#333333', fontSize: 13, fontWeight: '600' },
  card: { padding: 18 },
  fieldLabel: { color: '#333333', fontSize: 12, fontWeight: '700', marginBottom: 8 },
  fieldSpacer: { marginTop: 18 },
  value: { color: '#111111', fontSize: 15, fontWeight: '700' },
  valueInline: { color: '#000000', fontSize: 15, fontWeight: '700' },
  input: {
  ...
  birthHint: { color: '#333333', fontSize: 11, marginBottom: 4 },
  birthValue: { color: '#000000', fontSize: 13, fontWeight: '700' },
  ...
  menuTitle: { color: '#000000', fontWeight: '800', fontSize: 16, marginBottom: 8 },
